...
### 날씨카피앱(iOS앱)
- 개요 : 코드만을 사용해서 구현한 애플 기본날씨앱 카피앱(보완 )
- 기간 : 진행 중(2019. 08.~)
- 소속 : 개인프로젝트
- 역할 : 1인 개발
- 사용기술 : Swift
- 개발후기 : 코드만을 활용한 애플 날씨앱의 카피앱 프로젝트입니다. 스토리보드 사용없이 코드로 구현했습니다. 코드 구조에 대한 고민 등 많은 문제점을 마주하고 해결해볼 수 있는 경험이 되었습니다. 기능구현 이후 추가적인 리펙토링을 진행중에 있습니다.
