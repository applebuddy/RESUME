...
- 세부설명 : 스토리보드 사용없는 순수 코드구현 프로젝트, 페이지뷰 구현, 다중 API 처리 구현.
...
- 역할 : 수강생
- 사용기술 : Swift
- 세부설명 : 커넥트재단의 부스트코스 iOS과정 간 5가지 iOS앱(음악재생, 회원가입창, 날씨정보, 사진앨범, 영화정보앱)을 구현, 리뷰어 리뷰 통과 후 수료
...
## 부스트코스 iOS 에이스과정
- 개요 : 부스트코스 iOS 에이스과정 참여, 페이스메이커 활동
  - 부스트코스 프로젝트 관련 학습내용 기록 및 공유, 에이스 수강생 멘토활동(페이스 메이커)
- 기간 : 진행 중 (2019. 07. ~ 2019. 09.)
- 역할 : 수강생
- 사용기술 : Swift
- 세부설명 : 부스트코스 iOS과정 수료자로써 부스트코스 에이스과정에 참여, 페이스메이커 활동으로 부스트코스 수강생들과 교류
