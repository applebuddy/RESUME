...
### 유용하고 멋진앱을 자유자재로 만들고 싶은 개발자 지망자입니다.
그 꿈을 이루기 위해 개인/팀프로젝트와 스터디 등에 참여하며 개발활동을 하고 있습니다.
...
### 애플 날씨카피앱(iOS앱)
- 개요 : 코드만을 사용해서 구현한 애플 기본날씨앱 카피앱(리펙토링 진행중)
- 기간 : 2주(2019. 08.)
- 소속 : 개인프로젝트
- 역할 : 1인 개발
- 사용기술 : Swift
- 활용 프레임워크 : MapKit, CoreLocation
- 개발후기 : 코드만을 활용한 애플 날씨앱의 카피앱 프로젝트입니다. 스토리보드 사용없이 코드로 구현한 프로젝트입니다. 다수의 API데이터 처리 간 많은 문제점을 마주하고 해결해볼 수 있었으며 페이지뷰 구현, 전반적 코드구조 등에 대해 고민을 해보게 되었습니다. 기본구현 이후 부족한 부분에 대한 공부와 병행하며 추가적인 코드 구조 리펙토링을 진행 중에 있습니다.
...
- 기간 : 운영 중(2019. 03.~)
- 역할 : 커뮤니티 관리자
  - 커뮤니티 운영 및 소통으로 스터디, 정보교류를 하고 있습니다. 커뮤니티 활동을 통해 많은 사람들과 정보를 주고받으며 시너지효과를 얻고 있습니다. 정보교류 이외로 몇몇 분들과는 온/오프라인 스터디, 팀프로젝트를 진행하고 있습니다.
- 커뮤니티 링크 :
