...
- 사용기술 : Swift
- 개발후기
  - 딥러닝 기반 옷장관리 및 코디추천 앱 개발, 딥러닝(PyTorch) & 백엔드(Django) 협업 개발경험
...
### 가격알람앱 (iOS앱)
- 개요 : 거래소 가격 푸시알람앱 (iOS 앱스토어 배포, 현 게시 중단)
- 기간 : 2018. 12. ~ 2019. 02.
- 소속 : 개인프로젝트
- 역할 : 1인 개발
- 사용기술 : Swift, Firebase, gCloud
- 개발후기 : 구글클라우드, Firebase 활용 푸시알람앱 구현 경험
...
### 전역일계산기 (iOS앱)
- 개요 : 육군, 해군, 공군 전역일 계산앱 (iOS 앱스토어 배포, 현 게시 중단)
- 기간 : 2018. 11. ~ 2018. 12.
- 소속 : 개인프로젝트
- 역할 : 1인 개발
- 사용기술 : Swift
...
### 메모앱 프로젝트 (iOS앱)
- 개요 : 코드+xib / 스토리보드+xib 두가지 방식 메모앱 개발 연습
- 기간 : 2020. 02.
- 소속 : 개인프로젝트 
- 역할 : 1인 개발
- 사용기술 : Swift
