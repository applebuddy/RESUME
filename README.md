...
- 개발후기 : 2014년 말, 일본의 "냥코대전쟁" 게임을 모티브로 "멍구스토리" 1인 게임 개발. 장교 입대 전 앱 배포를 할 수 있었습니다. 500명 이상의 다운로드 기록. 
...
- 사용기술 : Swift
- 활용 프레임워크 : Alamofire
- 개발후기 : 암호화폐거래소 빗썸의 API를 활용한 암호화폐 정보를 제공 앱. 푸시알람 기능 등 추가 구현 예정.
...
- 개발후기 : 스토리보드 사용없는 순수 코드구현 프로젝트입니다. 다수의 API데이터 처리 간 많은 문제점을 마주하고 해결해볼 수 있었으며 페이지뷰 구현, 전반적 코드구조 등에 대해 고민을 해보게 되었습니다.
...
- 역할 : 수강생
- 사용기술 : Swift
- 수료후기 : 커넥트재단의 부스트코스 iOS과정 간 5가지 iOS앱(음악재생, 회원가입창, 날씨정보, 사진앨범, 영화정보앱)을 구현했고 리뷰어 리뷰까지 통과 하여 수료했습니다. 현업개발자 리뷰어 의 조언을 통해 이전의 잘못된 개발습관(옵셔널바인딩, 마크업 주석, 들여쓰기, 네이밍등)을 교정할 수 있었고, 리펙토링, 프로토콜, 디자인패턴 등에 대한 중요성을 배울 수 있었습니다. 
...
- 기간 : 참여 중 (2019. 09. 21. ~)
- 역할 ; 프론트엔드 iOS 개발
  - 웹, iOS, AOS, 딥러닝 개발자들이 모여 협업프로젝트를 진행하는 IT연합동아리, 프로그라피 참여 중
