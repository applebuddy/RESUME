...
### 유용하고 멋진앱을 자유자재로 만들며 많은 분들과 열정을 나누고 싶은 개발자입니다.
그 꿈을 이루기 위해 개인/팀프로젝트와 스터디 등과 병행하며 개발활동을 하고 있습니다.
...
- 개발후기 : 2014년 말, 대학생 시절 재밌게 플레이 하던 일본의 "냥코대전쟁" 게임을 모티브로 개를 주인공으로 고양이들을 물리치는 "멍구스토리" 게임 개발을 시작했습니다. 장교 입대 전 앱 배포를 할 수 있었습니다. 500명 이상의 다운로드를 기록했습니다. 
...
- 역할 : 1인 개발, 디자인
- 사용기술 : Swift
- 개발후기 : 기본적인 오토레이아웃, 전역일 계산기능 구현, 일련의 iOS앱 배포과정 경험
...
### 히트가격알람(iOS앱)
- 개요 : 모 암호화폐거래소 타켓 가격 푸시알람앱(iOS 앱스토어 배포, 현재 게시 중단)
- 기간 : 2개월 (2018. 12. ~ 2019. 02.)
- 소속 : 개인프로젝트
- 역할 : 1인 개발, 디자인
- 사용기술 : Swift, nodejs, Firebase(DB, Cloud function), gCloud
- 개발후기 : 기업체 고객 타겟으로 거래소 암호화폐의 가격푸시 알람 앱을 만들었습니다. 거래소 암호화폐의 실시간 가격확인, 타겟가격 도달 시 푸시알람기능 구현
...
- 개발후기 : 코드만을 활용한 애플 날씨앱의 카피앱 프로젝트입니다. 스토리보드 사용없이 순수 코드로 구현한 프로젝트입니다. 다수의 API데이터 처리 간 많은 문제점을 마주하고 해결해볼 수 있었으며 페이지뷰 구현, 전반적 코드구조 등에 대해 고민을 해보게 되었습니다. 기본구현 이후 부족한 부분에 대한 공부와 병행하며 추가적인 코드 구조 리펙토링을  중에 있습니다.
...
- 역할 : 1인 개발
- 사용기술 : Swift
- 해외 영화정보 API를 활용한 영화데이터, 이미지 네트워킹 처리 및 커스텀 MVC 델리게이션 패턴 구현연습
...
## 부스트코스 iOS과정 수료
- 개요 : 부스트코스 iOS과정 수료
  - 음악재생앱, 회원가입 인터페이스, 날씨정보, 사진앨범, 영화정보 앱 개발 및 부스트코스 리뷰어 리뷰통과
- 기간 : 3개월 (2019. 01. ~ 2019. 04.)
- 역할 : 수강생
- 사용기술 : Swift
- 수료후기 : 커넥트재단의 부스트코스 iOS과정을 통해 총 5가지 iOS앱(음악재생, 회원가입창, 날씨정보, 사진앨범, 영화정보앱)을 만들어 볼 수 있었습니다. 이전의 잘못된 개발습관(옵셔널바인딩, 마크업 주석, 들여쓰기, 네이밍등)을 교정할 수 있었고, 테이블뷰/컬렉션뷰/네트워킹처리/비동기처리 기능 을 구현할 수 있었습니다. 현업개발자 리뷰어 의 조언을 통해 프로토콜/디자인패턴에 대한 중요성을 배울 수 있었습니다. 
...
- 개요 : 부스트코스 iOS 에이스과정 참여
  - 부스트코스 프로젝트 관련 학습내용 기록 및 공유, 에이스 수강생 멘토활동(페이스 메이커)
- 기간 : 진행 중 (2019. 07.~)
- 역할 : 수강생
- 사용기술 : Swift
- 수료후기 : 부스트코스 iOS과정 수료자로써 부스트코스 에이스과정에 참여했습니다. 부스트코스에 도전하는 수강생들과 교류하며 만들었던 부스트코스 프로젝트를 돌아보고 있습니다. 개발자문서, 기능구현방법 등의 학습내용을 포스팅하고 공유하는 시간을 갖고 있습니다.
...
- 기간 : 운영 중 (2019. 03.~)
- 역할 : 커뮤니티 관리자
  - 커뮤니티 운영 및 소통으로 스터디, 정보교류를 하고 있습니다. 커뮤니티 활동을 통해 많은 사람들과 정보를 주고받으며 시너지효과를 얻고 있습니다.
- 커뮤니티 링크 :
...
- 기간 : 활동예정 (2019. 09. 21. ~)
- 역할 ; 프론트엔드 iOS 개발
  - 웹, iOS, AOS, 딥러닝 개발자들이 모여 협업프로젝트를 진행하는 IT연합동아리, 프로그라피 참여 예정
<div>
