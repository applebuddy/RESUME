...
- 개발후기 : 코드만을 활용한 애플 날씨앱의 카피앱 프로젝트입니다. 스토리보드 사용없이 순수 코드로 구현한 프로젝트입니다. 다수의 API데이터 처리 간 많은 문제점을 마주하고 해결해볼 수 있었으며 페이지뷰 구현, 전반적 코드구조 등에 대해 고민을 해보게 되었습니다. 기본구현 이후 부족한 부분에 대한 공부와 병행하며 추가적인 코드 구조 리펙토링을 계획 중에 있습니다.
...
- 기간 : 운영 중 (2019. 03.~)
- 역할 : 커뮤니티 관리자
  - 커뮤니티 운영 및 소통으로 스터디, 정보교류를 하고 있습니다. 커뮤니티 활동을 통해 많은 사람들과 정보를 주고받으며 시너지효과를 얻고 있습니다. 커뮤니티 활동을 통해 정보교류 이외로도 온/오프라인 스터디, 팀프로젝트 참여 등의 기회를 얻을 수 있었습니다. 
- 커뮤니티 링크 :
